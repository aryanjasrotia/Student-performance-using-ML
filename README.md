...
1. Clone the repository: `git clone https://github.com/aryanjasrotia/Predicting-Student-Performance-Using-Machine-Learning.git`
2. Navigate to the project directory: `cd Predicting-Student-Performance-Using-ML`
