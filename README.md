...
1. Clone the repository: `git clone https://github.com/aryanjasrotia/Student-Performance-Using-ML.git`
2. Navigate to the project directory: `cd Student-Performance-Using-ML`
